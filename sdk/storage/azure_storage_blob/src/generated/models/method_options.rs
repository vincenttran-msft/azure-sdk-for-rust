...
/// Options to be passed to `HierarchicalDirectoryClient::create()`
#[derive(Clone, Default, SafeDebug)]
pub struct HierarchicalDirectoryClientCreateOptions<'a> {
    /// Optional. Sets the blob's cache control. If specified, this property is stored with the blob and returned with a read
    /// request.
    pub blob_cache_control: Option<String>,
...
/// Options to be passed to `HierarchicalFileClient::create()`
#[derive(Clone, Default, SafeDebug)]
pub struct HierarchicalFileClientCreateOptions<'a> {
    /// Optional. Sets the blob's cache control. If specified, this property is stored with the blob and returned with a read
    /// request.
    pub blob_cache_control: Option<String>,
