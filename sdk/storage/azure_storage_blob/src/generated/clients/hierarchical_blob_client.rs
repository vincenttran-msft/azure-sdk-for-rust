...
use crate::generated::models::{
    HierarchicalBlobClientCreateOptions, HierarchicalBlobClientCreateResult,
};
use azure_core::{
    base64::encode,
...
#[tracing::client]
pub struct HierarchicalBlobClient {
...
/// Options used when creating a `HierarchicalBlobClient`
#[derive(Clone, SafeDebug)]
pub struct HierarchicalBlobClientOptions {
...
impl HierarchicalBlobClient {
    /// Creates a new HierarchicalBlobClient, using Entra ID authentication.
    ///
    /// # Arguments
    ///
    ...
    pub fn new(
        ...
        blob_name: String,
        options: Option<HierarchicalBlobClientOptions>,
    ) -> Result<Self> {
    ...
    #[tracing::function("Storage.Blob.Container.Blob.HierarchicalClient.create")]
    pub async fn create(
        &self,
        blob_content_length: u64,
        options: Option<HierarchicalBlobClientCreateOptions<'_>>,
    ) -> Result<Response<HierarchicalBlobClientCreateResult, NoFormat>> {
        let options = options.unwrap_or_default();
...
impl Default for HierarchicalBlobClientOptions {
    fn default() -> Self {
        Self {
