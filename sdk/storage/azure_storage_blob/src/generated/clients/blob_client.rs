...
use crate::generated::{
    clients::{AppendBlobClient, BlockBlobClient, HierarchicalBlobClient, PageBlobClient},
    models::{
...
impl BlobClient {
    ...
    /// Returns a new instance of HierarchicalBlobClient.
    #[tracing::subclient]
    pub fn get_hierarchical_blob_client(&self) -> HierarchicalBlobClient {
        HierarchicalBlobClient {
            blob_name: self.blob_name.clone(),
            container_name: self.container_name.clone(),
            endpoint: self.endpoint.clone(),
            pipeline: self.pipeline.clone(),
