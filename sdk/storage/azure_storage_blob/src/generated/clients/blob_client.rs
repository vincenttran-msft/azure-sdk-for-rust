...
use crate::generated::{
    clients::{
        AppendBlobClient, BlockBlobClient, HierarchicalDirectoryClient, HierarchicalFileClient,
        PageBlobClient,
    },
    models::{
...
impl BlobClient {
    ...
    /// Returns a new instance of HierarchicalDirectoryClient.
    #[tracing::subclient]
    pub fn get_hierarchical_directory_client(&self) -> HierarchicalDirectoryClient {
        HierarchicalDirectoryClient {
            blob_name: self.blob_name.clone(),
            container_name: self.container_name.clone(),
            endpoint: self.endpoint.clone(),
            pipeline: self.pipeline.clone(),
    ...
    /// Returns a new instance of HierarchicalFileClient.
    #[tracing::subclient]
    pub fn get_hierarchical_file_client(&self) -> HierarchicalFileClient {
        HierarchicalFileClient {
            blob_name: self.blob_name.clone(),
            container_name: self.container_name.clone(),
            endpoint: self.endpoint.clone(),
            pipeline: self.pipeline.clone(),
