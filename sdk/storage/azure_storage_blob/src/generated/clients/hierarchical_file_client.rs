...
use crate::generated::models::{
    HierarchicalFileClientCreateOptions, HierarchicalFileClientCreateResult,
};
use azure_core::{
    base64::encode,
...
#[tracing::client]
pub struct HierarchicalFileClient {
...
/// Options used when creating a `HierarchicalFileClient`
#[derive(Clone, SafeDebug)]
pub struct HierarchicalFileClientOptions {
...
impl HierarchicalFileClient {
    /// Creates a new HierarchicalFileClient, using Entra ID authentication.
    ///
    /// # Arguments
    ///
    ...
    pub fn new(
        ...
        blob_name: String,
        options: Option<HierarchicalFileClientOptions>,
    ) -> Result<Self> {
    ...
    #[tracing::function("Storage.Blob.Container.Blob.HierarchicalFileClient.create")]
    pub async fn create(
        &self,
        resource_type: &str,
        options: Option<HierarchicalFileClientCreateOptions<'_>>,
    ) -> Result<Response<HierarchicalFileClientCreateResult, NoFormat>> {
        let options = options.unwrap_or_default();
...
impl Default for HierarchicalFileClientOptions {
    fn default() -> Self {
        Self {
