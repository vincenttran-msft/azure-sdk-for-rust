...
pub use clients::{
    ...
    BlockBlobClientOptions, HierarchicalDirectoryClient, HierarchicalDirectoryClientOptions,
    HierarchicalFileClient, HierarchicalFileClientOptions, PageBlobClient, PageBlobClientOptions,
};
